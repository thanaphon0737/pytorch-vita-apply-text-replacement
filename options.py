...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--sub_image', type=int, default=0, help='0 for distance-based text image, 1 for black and white text image')
        # ouptput related
        self.parser.add_argument('--name', type=str, default='output', help='file name of the outputs')
        self.parser.add_argument('--pic', type=str, default='output', help='file name of the outputs')
        self.parser.add_argument('--result_dir', type=str, default='../output/', help='path for saving result images')
        self.parser.add_argument('--A', type=int,default=False, help='a_value')
        # model related
        self.parser.add_argument('--model_n', type=int, default='1', help='file name of the outputs')
...
class TrainShapeMatchingOptions():
    def __init__(self):
        ...
        # data loader realted 
        self.parser.add_argument('--text_name', type=str, default='../save/fire-GS.ckpt', help='path to load the saved G_S model when training G_T')  
        self.parser.add_argument('--name', type=str, default='../save/fire-GS.ckpt', help='path to load the saved G_S model when training G_T')  
        self.parser.add_argument('--std_name', type=str, default='../save/fire-GS.ckpt', help='path to load the saved G_S model when training G_T')   
        ...
        self.parser.add_argument('--l1', type=int, default=100, help='number of features in the first layer of D_T')      
        self.parser.add_argument('--sadv', type=float, default=0.1, help='number of features in the first layer of D_T')                  
        # trainingg related
...
class Trainandverify():
    def __init__(self):
        self.parser = argparse.ArgumentParser()

        # data loader related
        self.parser.add_argument('--file_name', type=str, default='./predict/', help='path of the text image')
        self.parser.add_argument('--pic', type=str, default='./predict/', help='path of the text image')
...
class Skeleton():
    def __init__(self):
        ...
        # data loader related
        self.parser.add_argument('--ref', type=str, default='./predict/', help='path of the text image')
        self.parser.add_argument('--pic', type=str, default='./predict/', help='path of the text image')
